...
class LX_TiankongView: UIView {
    ...
    func initView()  {
        ...
        self.image = UIImageView(frame: CGRect.init(x: 10, y: self.textview!.c_maxY() + 5, width: 50, height: 50))
        ...
        self.jiexiButton.frame = CGRect.init(x: 0, y: self.c_h - 30, width: self.c_w, height: 30)
