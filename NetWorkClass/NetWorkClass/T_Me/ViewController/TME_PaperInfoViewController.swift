//
//  TME_PaperInfoViewController.swift
//  NetWorkClass
//
...
class TME_PaperInfoViewController: BaseViewController {
    ...
    func initTitleView(){
        ...
        self.scrollView.contentSize = CGSize(width: SCREEN_WIDTH, height: SCREEN_HEIGHT + 100)
        ...
        Danxuan?.frame = CGRect(x: 0, y: self.TitleLabel.c_maxY(), width: SCREEN_WIDTH, height: SCREEN_HEIGHT - 100)
        Danxuan?.isHidden = true
        Danxuan?.defen.endEditing(false)
        Danxuan?.tijiaobtn.isHidden = true
        self.scrollView.addSubview(Danxuan!)
        
        self.tinakong = AP_TiankongView(frame: CGRect(x: 0, y: self.TitleLabel.c_h, width: SCREEN_WIDTH, height: SCREEN_HEIGHT - 100))
        self.tinakong?.isHidden = true
        self.tinakong?.defen.endEditing(false)
        self.tinakong?.isHidden = true
        self.tinakong?.tijiao.isHidden = true
        self.scrollView.addSubview(self.tinakong!)
