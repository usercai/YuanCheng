...
class TME_HomeWorkListViewController: BaseTableViewController {

    let viewmodel = TME_HomeWorkInfoViewModel()
...
extension TME_HomeWorkListViewController{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let model = self.dataSource[indexPath.row] as! Model_HomeWork
        let vc = TME_HomeWorkApproveViewController(model: model)
